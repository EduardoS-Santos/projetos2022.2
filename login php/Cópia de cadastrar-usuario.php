...
<head>
    ...
    <link rel="stylesheet" href="css/cadastro3.css">
...
<body>
   ...
   <section class="container">
    ...
    <div id="usuario">
           <label>Usuario: </label><input type="text" name="usuario" id="usuario"  required ><br>
                </div>
    <div id="senha">
    ...
    <div id="perfil">
           <label>Perfil: </label><input type="text" name="perfil" id="perfil"  required ><br>
               </div>
               <p>
            </p>
    <div id="datadata">
