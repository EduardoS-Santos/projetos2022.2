   ...
   <?php 
    ...
    <div class="container">
        ...
        <form action="atualizar-cliente.php" method="post">
            ...
            <label for="cpf">Cpf</label><input value="<?php echo $row["cpf"]; ?>" type="text" name="cpf" id="cpf" pattern="[0-9]{11}" title="Somente números" required maxlength="11">
