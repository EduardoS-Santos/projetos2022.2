...
<body>
   ...
   <div class="formu">
    <h3 class="pink-text">Consultar Usuario</h3>
...
<?php
    if(isset($_GET["nome"])){
        ...
        //instrução
        $sql = "select * from usuar where nome like '".$nome."%'" ;
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_array($result))
                    {
                        ...
                        <tr>
                            ...
                            <!-- Editar -->
                            <td> <a href="editar-usuario.php?cod=<?php echo $row["cod_usuario"]; ?>"> <i class="material-icons">Editar</i></a></td>
                            <!-- excluir -->
                            <td> <a href="#" onclick="confirmaExclusao(<?php echo $row["cod_usuario"]; ?>,'<?php echo $row["nome"]; ?>')"> <i class="material-icons">Excluir</i> </a></td>
                        </tr>
